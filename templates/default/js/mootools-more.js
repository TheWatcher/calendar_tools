...
}}return d;}});})();(function(){var b=null,a={},e={};var d=function(g){if(instanceOf(g,f.Set)){return g;}else{return a[g];}};var f=this.Locale={define:function(g,k,i,j){var h;
...
if(h!==false){j=this.getPosition();if(!this.retrieve("pin:_pinned")){var g={top:j.y-k.y,left:j.x-k.x,margin:"0px",padding:"0px"};if(a&&!f){this.setStyle("position","fixed").setStyles(g);
...
}},title:{match:null,convert:function(){return this.title;}}};HtmlTable.Parsers=new Hash(HtmlTable.Parsers);HtmlTable.defineParsers=function(c){HtmlTable.Parsers=Object.append(HtmlTable.Parsers,c);
